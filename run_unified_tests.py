...
def create_coverage_config():
    ...
    with open('.coveragerc', 'w') as f:
        ...
        f.write("    run_unified_tests.py\n")
        f.write("    copy_files_to_clipboard.py\n")
        f.write("    download_icons.py\n")
        f.write("    python-file-contents-collector.py\n")
        f.write("    setup.py\n")
        f.write("    # Alembic migrations\n")
        f.write("    alembic/*\n")
        f.write("    alembic/versions/*\n")
