from PySide6.QtWidgets import (
    ...
    QPushButton, QLineEdit, QTextEdit, QCheckBox, QLabel, QMessageBox,
    QHeaderView, QAbstractItemView, QGroupBox, QFormLayout, QComboBox
)
...
class UnitManagementDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.units_table.setHorizontalHeaderLabels(["Nombre", "Abreviación", "Descripción", "Activo"])
        ...
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # Abbreviation
        ...
        self.standard_unit_combo.currentIndexChanged.connect(self.on_standard_unit_selected)
    ...
    def filter_units(self):
        ...
        if not search_text:
            ...
            filtered_units = [
                ...
                if (search_text in unit.name.lower() or 
                    search_text in (unit.abbreviation or "").lower())
            ]
    ...
    def add_standard_unit(self):
        ...
        if existing:
            QMessageBox.information(self, "Información", f"La unidad '{unit_type.value}' ya existe.")
            return
        ...
        try:
            ...
            QMessageBox.information(self, "Éxito", f"Unidad '{unit.name}' agregada exitosamente.")
    ...
    def save_unit(self):
        ...
        if not name or not abbreviation:
            QMessageBox.warning(self, "Advertencia", "El nombre y la abreviación son obligatorios.")
            return
        ...
        try:
            if self.selected_unit and self.selected_unit.id:
                ...
                QMessageBox.information(self, "Éxito", "Unidad actualizada exitosamente.")
            else:
                # Add new unit
                unit = Unit(
                    name=name,
    ...
    def toggle_unit_status(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "Error", f"Error al cambiar el estado de la unidad: {e}")