...
from PySide6.QtTest import QTest as QtTestUtils
...
class TestErrorDialog:
    ...
    def test_show_details_functionality(self, detailed_error_dialog):
        ...
        QtTestUtils.mouseClick(dialog.details_button, Qt.MouseButton.LeftButton)
        QApplication.processEvents()
    ...
    def test_ok_button_closes_dialog(self, simple_error_dialog):
        ...
        with patch.object(dialog, 'accept') as mock_accept:
            # Click OK button
            QtTestUtils.mouseClick(dialog.ok_button, Qt.MouseButton.LeftButton)
    ...
    def test_escape_key_closes_dialog(self, simple_error_dialog):
        ...
        with patch.object(dialog, 'reject') as mock_reject:
            # Press Escape key
            QtTestUtils.keyClick(dialog, Qt.Key.Key_Escape)
    ...
    def test_enter_key_closes_dialog(self, simple_error_dialog):
        ...
        with patch.object(dialog, 'accept') as mock_accept:
            # Press Enter key
            QtTestUtils.keyClick(dialog.ok_button, Qt.Key.Key_Return)
    ...
    def test_dialog_keyboard_navigation(self, detailed_error_dialog):
        ...
        QtTestUtils.keyClick(dialog, Qt.Key.Key_Tab)
        QApplication.processEvents()
