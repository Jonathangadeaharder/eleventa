...
class SessionScopeProvider:
    ...
    def __init__(self):
        ...
        self._test_session = (
            None  # For test mode where we want to reuse the same session
        )
    ...
    def get_session(self) -> Any:
        ...
        if session_factory is None:
            raise ValueError(
                "No session factory has been set. Make sure to call set_default_session_factory or set_session_factory first."
            )
